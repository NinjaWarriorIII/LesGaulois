...
public class Village {
	...
	public void afficherVillageois() {
		System.out.println(
				"Dans le village \"Village des Irr�ductibles\" du chef" + chef + "vivent les l�gendaires gaulois :");
	...
	public static void main(String[] args) {
		...
		Village village = new Village("Village des Irr�ductibles", abraracourix, 30);
